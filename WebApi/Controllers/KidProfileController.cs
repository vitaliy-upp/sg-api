...
namespace NoLimitTech.WebApi.Controllers
{
    ...
    public class KidProfileController : ControllerBase
    {
        ...
        public KidProfileController(IUserService userApplicationService
        ...
        /// <summary>
        /// Get All My Kids' Profiles
        /// </summary>
        /// <returns>Kid Profile Model</returns>
        [HttpGet]
        [ProducesResponseType(typeof(IEnumerable<KidProfileDto>), StatusCodes.Status200OK)]
